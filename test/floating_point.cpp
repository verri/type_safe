...
//=== With default ===//
static_assert(std::is_pod<floating_point<float, true>>::value, "");
// conversion checks
static_assert(std::is_constructible<floating_point<float, true>, float>::value, "");
static_assert(!std::is_constructible<floating_point<float, true>, double>::value, "");
static_assert(std::is_constructible<floating_point<double, true>, double>::value, "");
static_assert(std::is_constructible<floating_point<double, true>, double>::value, "");
static_assert(!std::is_constructible<floating_point<double, true>, long double>::value, "");
static_assert(std::is_assignable<floating_point<float, true>, float>::value, "");
static_assert(!std::is_assignable<floating_point<float, true>, double>::value, "");
static_assert(std::is_assignable<floating_point<double, true>, double>::value, "");
static_assert(std::is_assignable<floating_point<double, true>, double>::value, "");
static_assert(!std::is_assignable<floating_point<double, true>, long double>::value, "");
#endif
...
TEST_CASE("floating_point")
{
    ...
    SECTION("addition")
    {
        ...
        static_assert(std::is_same<decltype(wrapper), decltype(wrapper + (-2.3))>::value, "");
...
TEST_CASE("floating_point with default")
{
    using float_t = floating_point<double, true>;
    ...
    SECTION("constructor")
    {
        ...
        REQUIRE(static_cast<double>(c) == -42.5);
        float_t d = {};
        REQUIRE(static_cast<double>(d) == double{});
    }
    SECTION("assignment")
    {
        float_t a(0.);
